  ...
  <LayoutAbout :title="title">
    ...
    <template v-if="lang == 'ja'">
      ...
      <figure>
        <img
          width="183"
          :src="baseUrl + '/assets/img/about/mes_img01.jpeg'"
